...
After being confused by this point for some time, I [prepared these notes](/blog/dirichlet-distribution/) arguging that the Dirichlet process _is_ a distribution over distributions. I argued that the term _sample from a Dirichlet process_ should refer to a distribution sampled from the DP, not to a point sampled from the support of $G_0$.
