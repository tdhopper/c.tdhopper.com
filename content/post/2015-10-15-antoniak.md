...
tags:
  ...
  - dirichlet-processes
  - python
description: "Code for drawing samples from the distribution of tables created by a Chinese restaurant process after n patrons are seated."
image: /images/antoniak-mr-men.png
---

`rand_antoniak` draws a sample from the distribution of tables created by a Chinese restaurant process with parameter `alpha` after `n` patrons are seated. Some notes on this distribution are [available here](http://www.cs.cmu.edu/~tss/antoniak.pdf).
